    ...
    return (
        <div id="alert-1" className="flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
            ...
            <div className="ms-3 text-sm font-medium">
                For Transfer Money to another account use Phone 10 times  <p className="font-semibold ">2222222222</p> and then  put amount  after sending money please Refersh the page to show transaction
            </div>
            <button
                type="button"
